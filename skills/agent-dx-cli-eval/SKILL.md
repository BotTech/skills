...
- `../gsd-new-cli-project/references/rewrite-your-cli-for-ai-agents.md` — Full principles
- `../gsd-new-cli-project/references/agent-dx-cli-scale.md` — Original 7-axis scale
